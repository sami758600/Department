...
<div class="card shadow-sm mb-4">
    ...
    <div class="list-group list-group-flush">
        <a href="<?php echo BASE_URL; ?>/public/pages/Academics/timetables.php" class="list-group-item list-group-item-action">
            Time Tables
        </a>
        <a href="<?php echo BASE_URL; ?>/public/pages/department/univacedcal.php" class="list-group-item list-group-item-action">
            University Academic Calendar
        </a>
        <a href="<?php echo BASE_URL; ?>/public/pages/department/itacedcal.php" class="list-group-item list-group-item-action">
