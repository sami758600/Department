        ...
        <div class="col-lg-3">
            <aside class="user-side-panel">
                ...
                <nav class="user-side-nav user-side-nav-main">
                    ...
                    <a class="user-side-link active" href="<?php echo BASE_URL; ?>/public/pages/user/achievements.php"><i class="bi bi-trophy user-side-link-icon"></i><span>Upload Achievement</span></a>
