        ...
        <div class="col-lg-3">
            <aside class="user-side-panel">
                ...
                <nav class="user-side-nav user-side-nav-main">
                    ...
                    <a class="user-side-link active" href="<?php echo BASE_URL; ?>/public/pages/user/academics.php"><i class="bi bi-mortarboard user-side-link-icon"></i><span>Academics</span></a>
